...
const ViewPortfolio = () => {
  ...
  return (
    <div className="container-fluid p-0" style={{ background: "#f8f9fa", minHeight: "100vh" }}>
      {/* Header */}
      <header className="d-flex justify-content-between align-items-center p-3" style={{ background: "#007bff", color: "#ffffff" }}>
      ...
      <div className="d-flex flex-column flex-md-row">
        {/* Left Section */}
        <div className="col-md-3 p-4 text-center" style={{ background: "#ffffff", borderRight: "2px solid #dee2e6" }}>
          <motion.img
          ...
          />
          <h5 className="mt-3 font-weight-bold" style={{ color: "#343a40" }}>{data.name}</h5>
          ...
          <div className="d-flex flex-column gap-2 mt-3">
            ...
            <a href={data.resume} className="btn btn-warning text-dark" download>
        ...
        <div className="col-md-9 p-4">
          <nav className="nav nav-tabs">
            <a className="nav-link active text-primary" data-bs-toggle="tab" href="#projects">
              Projects
            </a>
            <a className="nav-link text-secondary" data-bs-toggle="tab" href="#skills">
              Skills
            </a>
            <a className="nav-link text-secondary" data-bs-toggle="tab" href="#about">
              About Me
            </a>
            <a className="nav-link text-secondary" data-bs-toggle="tab" href="#experience">
              Experience
            </a>
          </nav>
              ...
              <div className="row">
                {data.projects.map((project, index) => (
                  <motion.div key={index} className="col-12 col-sm-6 col-md-4 mb-3" whileHover={{ scale: 1.05 }}>
                    <div className="card shadow-sm border-0" style={{ background: "#ffffff", borderRadius: "10px" }}>
      ...
      {/* Footer */}
      <footer className="text-center p-3 mt-3" style={{ background: "#6c757d", color: "#ffffff" }}>
      ...
      <AnimatePresence>
        {showSidebar && (
          <motion.div
            ...
            style={{ width: "25%", backgroundColor: "#ffffff", borderRight: "2px solid #dee2e6" }}
            initial={{ x: "-100%" }}
            animate={{ x: 0 }}
            exit={{ x: "-100%" }}
          ...
          >
            ...
            <h4 className="text-center mb-4" style={{ color: "#007bff" }}>Login</h4>
            <form>
              <div className="mb-3">
