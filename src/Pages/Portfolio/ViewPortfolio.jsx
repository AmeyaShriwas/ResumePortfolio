...
setLoginData((prev)=> ({
  ...
  return (
    ...
    <header style={{ backgroundColor: "white", color: "black" }} className="d-flex justify-content-between border align-items-center p-3">
      ...
      <button className="btn" style={{ backgroundColor: "#F5F5F5", color: "black" }} onClick={() => setShowSidebar(true)}>
        <FaUser /> Login
      </button>
    </header>
    ...
    <div className="d-flex flex-column flex-md-row">
      ...
      <div className="col-md-3 bg-white p-4 text-center border">
        ...
        />
        <h5 className="mt-3 font-weight-bold text-black">{data.name}</h5>
        {data.bio && <p className="px-3 text-black">{data.bio}</p>}
        <div className="d-flex flex-column gap-2 mt-3">
          <a href={data.linkedin} target="_blank" rel="noopener noreferrer" className="btn" style={{ backgroundColor: "#F5F5F5", color: "black" }}>
            <FaLinkedin /> LinkedIn
          </a>
      ...
      <div className="col-md-9 p-4">
        <nav className="nav nav-tabs">
          <a className="nav-link active text-black" data-bs-toggle="tab" href="#projects">Projects</a>
          <a className="nav-link text-black" data-bs-toggle="tab" href="#skills">Skills</a>
          <a className="nav-link text-black" data-bs-toggle="tab" href="#about">About Me</a>
          <a className="nav-link text-black" data-bs-toggle="tab" href="#experience">Experience</a>
        </nav>
                ...
                <motion.div key={index} className="col-12 col-sm-6 col-md-4 mb-3" whileHover={{ scale: 1.05 }}>
                  <div className="card shadow-sm border-0">
                    ...
                    <div className="card-body">
                      <h6 className="card-title text-black">{project.projectName}</h6>
    ...
    <AnimatePresence>
      {showSidebar && (
        <motion.div
          className="position-fixed top-0 start-0 vh-100 text-black p-4 shadow-lg"
        ...
        >
          ...
          <h4 className="text-center mb-4 text-black">Login</h4>
          <form>
            <div className="mb-3">
            ...
            <button type="submit" onClick={handleLoginSubmit} className="btn w-100" style={{ backgroundColor: "#F5F5F5", color: "black" }}>Login</button>
          </form>
        </motion.div>
      )}
    </AnimatePresence>
