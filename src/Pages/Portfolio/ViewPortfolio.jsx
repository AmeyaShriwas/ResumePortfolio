...
const ViewPortfolio = () => {
  ...
  return (
    <div className="bg-gradient min-vh-100 text-white" style={{ background: "linear-gradient(135deg, #A3D1C6, #B3D8A8)" }}>
      {/* Navbar */}
      ...
      {/* Sidebar */}
      <div className={`sidebar bg-dark text-light p-4 position-fixed top-0 end-0 vh-100 shadow-lg transition ${showSidebar ? "d-block" : "d-none"}`} style={{ width: "300px" }}>
      ...
      <section className="text-center my-5 pt-5">
        ...
        {data.bio && <p className="px-3 lead text-light">{data.bio}</p>}
      </section>
